...
export default function HomePage() {
  ...
  const [theme, setThemeState] = useState<"dark" | "light">(() => {
    if (typeof window !== "undefined") {
      return (localStorage.getItem("theme_preference") as "dark" | "light") || "dark";
    }
    return "dark";
  });
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden selection:bg-indigo-500/30">
      ...
      {/* Top Navbar */}
      <header className="relative max-w-7xl mx-auto px-6 h-20 flex items-center justify-between border-b border-slate-900/60 z-55">
        ...
        <div className="hidden sm:flex items-center gap-6 text-sm font-semibold text-slate-400">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900/40 border border-slate-900 text-slate-400 hover:text-slate-200 transition-all duration-300"
          >
            {theme === "dark" ? (
          ...
          <Link
            href="/login"
            className="px-4 py-2 rounded-xl text-sm font-semibold text-slate-350 hover:bg-slate-900 border border-transparent hover:border-slate-800 transition-all duration-300"
          >
            Log in
          </Link>
          <Link
      ...
      <section className="relative max-w-5xl mx-auto px-6 pt-20 pb-12 text-center z-10">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-none bg-gradient-to-r from-white via-slate-200 to-indigo-300 bg-clip-text text-transparent">
        ...
        <p className="mt-6 text-base sm:text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Unlock your true productivity potential with daily streak tracking, interactive progress charts, and customized profile achievements in a premium dark glassmorphic dashboard.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 px-7 py-3.5 text-sm font-bold text-slate-300 hover:text-white transition-all duration-300"
          >
      ...
      <section className="max-w-5xl mx-auto px-6 pb-24 relative z-10">
        <motion.div
          ...
          className="rounded-2xl border border-slate-800/80 bg-slate-900/20 backdrop-blur-xl p-4 sm:p-6 shadow-[0_0_80px_rgba(99,102,241,0.15)] glow-border-indigo"
        >
          {/* Mockup Header bar */}
          <div className="flex items-center justify-between border-b border-slate-850 pb-4 mb-4">
            ...
            <div className="rounded-lg bg-slate-950 border border-slate-850 px-8 py-1 text-[10px] font-semibold text-slate-500 tracking-wide">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-2 border border-slate-800/85 bg-slate-950/40 rounded-xl p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-xs font-bold text-slate-500 uppercase">Today's Progress</p>
                  <p className="text-base font-bold text-slate-200 mt-0.5">3 of 4 completed (75%)</p>
                </div>
                <span className="text-xs font-semibold px-2 py-1 rounded bg-indigo-500/10 text-indigo-400">🔥 Level 2</span>
              </div>
              <div className="h-2 w-full rounded-full bg-slate-900 overflow-hidden mb-6">
                <div className="h-full bg-gradient-to-r from-indigo-500 to-purple-600 w-3/4 shadow-[0_0_10px_rgba(99,102,241,0.5)]" />
              </div>

              {/* Mock Habits */}
              <div className="space-y-3">
                <div className="flex items-center justify-between bg-slate-900/30 border border-slate-800/50 rounded-lg p-3">
                  <div className="flex items-center gap-3">
                    <div className="flex h-5 w-5 items-center justify-center rounded bg-emerald-500 text-white text-[10px]">✓</div>
                    <div>
                      <p className="text-xs font-bold text-slate-300">Meditation & Breathing 🧘</p>
                      <p className="text-[10px] text-slate-500">10 mins mindfulness</p>
                    </div>
                  </div>
                  <span className="text-[10px] font-semibold text-amber-400 border border-amber-500/20 bg-amber-500/10 px-2.5 py-0.5 rounded-full">🔥 5 days</span>
                </div>
                <div className="flex items-center justify-between bg-slate-900/30 border border-slate-800/50 rounded-lg p-3">
                  <div className="flex items-center gap-3">
                    <div className="flex h-5 w-5 items-center justify-center rounded bg-emerald-500 text-white text-[10px]">✓</div>
                    <div>
                      <p className="text-xs font-bold text-slate-300">Read 15 Pages 📚</p>
                      <p className="text-[10px] text-slate-500">Design systems and system architecture</p>
                    </div>
                  </div>
                  <span className="text-[10px] font-semibold text-amber-400 border border-amber-500/20 bg-amber-500/10 px-2.5 py-0.5 rounded-full">🔥 3 days</span>
                </div>
                <div className="flex items-center justify-between bg-slate-900/30 border border-slate-850 rounded-lg p-3 opacity-60">
                  <div className="flex items-center gap-3">
                    <div className="h-5 w-5 rounded border border-slate-700 bg-slate-950" />
                    <div>
                      <p className="text-xs font-bold text-slate-300">Drink 3L Water 💧</p>
                      <p className="text-[10px] text-slate-500">Hourly logs</p>
                    </div>
                  </div>
                  <span className="text-[10px] font-semibold text-slate-500 border border-slate-800 bg-slate-900 px-2.5 py-0.5 rounded-full">— 0 days</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="border border-slate-800 bg-slate-950/40 rounded-xl p-5 flex-1">
                ...
                <div className="mt-4 flex items-end gap-1 h-16 pl-1">
                  ...
                  <div className="w-full bg-slate-800 h-12 rounded-sm" />
      ...
      {/* FEATURES SECTION */}
      <section id="features" className="max-w-6xl mx-auto px-6 py-24 border-t border-slate-900/80 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
            Re-engineered Habit Building
          </h2>
          <p className="mt-4 text-slate-400 max-w-xl mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feat, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative overflow-hidden rounded-2xl border border-slate-800/80 bg-slate-900/20 p-6 backdrop-blur-md hover:border-indigo-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_30px_-8px_rgba(99,102,241,0.12)]"
              >
      ...
      <section className="max-w-5xl mx-auto px-6 py-20 border-t border-slate-900/85 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((test, idx) => (
            <div
              key={idx}
              className="rounded-2xl border border-slate-850 bg-slate-900/10 p-6 backdrop-blur-md flex flex-col justify-between"
            >
              <p className="text-slate-350 text-sm leading-relaxed italic font-medium">
                "{test.text}"
              </p>
              <div className="flex items-center gap-3 mt-6 border-t border-slate-900 pt-4">
                <img src={test.avatar} alt={test.name} className="h-9 w-9 rounded-full bg-slate-900 border border-slate-800" />
                <div>
                  <p className="text-xs font-bold text-slate-250">{test.name}</p>
      ...
      {/* PRICING SECTION */}
      <section id="pricing" className="max-w-4xl mx-auto px-6 py-24 border-t border-slate-900/80 relative z-10">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-5xl font-extrabold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
          ...
          {/* Pricing Toggle */}
          <div className="inline-flex items-center gap-2 rounded-xl bg-slate-950 border border-slate-905 p-1 mt-8">
            <button
              onClick={() => setBillingPeriod("monthly")}
              className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${
                billingPeriod === "monthly" ? "bg-slate-900 text-indigo-400" : "text-slate-500 hover:text-slate-300"
              }`}
            >
              Monthly
            </button>
            <button
              ...
              className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${
                billingPeriod === "annually" ? "bg-slate-900 text-indigo-400" : "text-slate-500 hover:text-slate-300"
              }`}
            >
              Annually
              <span className="px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 text-[9px] font-extrabold uppercase">Save 20%</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-4">
          {/* Free Card */}
          <div className="rounded-2xl border border-slate-800 bg-slate-950/30 p-8 backdrop-blur-sm flex flex-col justify-between">
            <div>
              <p className="text-xs font-extrabold text-slate-500 uppercase tracking-widest">Base Tier</p>
              <h3 className="text-2xl font-bold text-slate-200 mt-2">Free Sandbox</h3>
              <p className="text-slate-400 text-xs mt-1.5">For core accountability habits.</p>
              ...
              <ul className="space-y-3 mt-8 text-xs font-semibold text-slate-400">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Up to 5 Active Habits</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Heatmap & Calendar View</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Standard Level Rewards (XP)</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Localstorage Fallback Database</li>
              </ul>
            </div>
            
            <Link
              href="/register"
              className="mt-8 block w-full rounded-xl bg-slate-900 border border-slate-800 hover:border-slate-700 py-3 text-center text-xs font-bold text-slate-300 hover:text-white transition-all"
            >
              Sign Up Free
            </Link>
          </div>
          ...
          {/* Pro Card */}
          <div className="relative rounded-2xl border-2 border-indigo-500 bg-slate-900/40 p-8 backdrop-blur-md shadow-2xl flex flex-col justify-between shadow-indigo-500/10">
            ...
            <div>
              <p className="text-xs font-extrabold text-indigo-400 uppercase tracking-widest">Premium Tier</p>
              <h3 className="text-2xl font-bold text-slate-100 mt-2">HabitFlow Pro</h3>
              <p className="text-slate-400 text-xs mt-1.5">For individuals optimizing daily performance.</p>
              ...
              <ul className="space-y-3 mt-8 text-xs font-semibold text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> **Unlimited** Habits tracking</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Automatic Progress Insights panel</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Premium Trophy unlock rewards</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Weekly summary email reports</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-400" /> Priority API sync latency support</li>
              </ul>
            </div>
      ...
      {/* FAQ SECTION */}
      <section id="faqs" className="max-w-3xl mx-auto px-6 py-20 border-t border-slate-900/80 relative z-10">
        <h2 className="text-2xl sm:text-4xl font-extrabold text-center text-slate-200 mb-12">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="rounded-xl border border-slate-850 bg-slate-900/10 overflow-hidden"
            >
              <button
                onClick={() => setOpenFaq(openFaq === idx ? null : idx)}
                className="w-full flex items-center justify-between p-5 text-left font-bold text-slate-300 hover:text-slate-150 transition-colors"
              >
                <span>{faq.q}</span>
                <ChevronDown className={`h-4 w-4 text-slate-500 transition-transform duration-300 ${openFaq === idx ? "rotate-180 text-indigo-400" : ""}`} />
              </button>
              {openFaq === idx && (
                <div className="px-5 pb-5 text-xs text-slate-400 leading-relaxed font-semibold border-t border-slate-900/40 pt-4">
                  {faq.a}
                </div>
              )}
            </div>
      ...
      {/* FOOTER */}
      <footer className="border-t border-slate-900/80 bg-slate-950/80 py-12">
